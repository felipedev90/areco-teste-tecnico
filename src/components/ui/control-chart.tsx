export function ControlChart() {
  return (
    ...
    >
      ...
      <text x="8" y="74" className="font-mono" fontSize="10" fill="var(--color-muted)">
        LSC
      </text>
      <text x="8" y="149" className="font-mono" fontSize="10" fill="var(--color-muted)">
        LC
      </text>
      <text x="8" y="224" className="font-mono" fontSize="10" fill="var(--color-muted)">
        LIC
      </text>
